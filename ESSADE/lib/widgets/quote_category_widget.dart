...
class QuoteCategoryWidget extends StatelessWidget {
  ...
  const QuoteCategoryWidget({Key key, this.name, this.icon, this.isSelected = false}) : super(key: key);
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              color: isSelected ? essadePrimaryColor.withOpacity(0.2) : Colors.white,
            ),
            child: Column(
